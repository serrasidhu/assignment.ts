...
function insertValueAtIndex(arr :number[],index:number, value:number ):number [] {
...
let shoppingCart:string[] = ['fruit', 'vegetable', 'Cookies'];
function addItems(itemsValue:number,itemsName:string) {
...
let shoppingCart1:string[] = ['fruit', 'vegetable', 'Cookies'];
function removeItems(items:number,removeItemsName:string) {
...
let shoppingCart2:string[]=['fruit', 'vegetable', 'Cookies'];
function updateItems(item:number,updateItemsName:string) {
